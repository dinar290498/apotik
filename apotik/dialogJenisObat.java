...
/*
 * dialogJenisObat.java
 *
 * Created on Mar 10, 2011, 1:13:20 AM
 */
 ...
 * @author SAD
 */
public class dialogJenisObat extends javax.swing.JDialog {

    /** Creates new form dialogJenisObat */
    public dialogJenisObat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void botton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botton1ActionPerformed
        if(!jTextField1.getText().trim().equals("")){
            dtJenisObat dtjo=new dtJenisObat();
            dtjo.setNamaJenisObat(jTextField1.getText());

            if(dbJenisObat.insert(dtjo))
                tmJenisObat.insert(dtjo);
            
            jTextField1.setText("");
        }
        else
            JOptionPane.showMessageDialog(rootPane, "Isi Jenis Obat !!!","ERROT",JOptionPane.ERROR_MESSAGE);
    ...
    private void botton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botton2ActionPerformed
        ...
        if(n>=0){
            if(dbJenisObat.delete(tmJenisObat.fieldJenisObat.get(n).getNamaJenisObat()))
                tmJenisObat.delete(n);
        }
        else
    ...
    tmJenisObat tmJenisObat=new tmJenisObat();
