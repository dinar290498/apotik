...
/*
 * dialogPelanggan.java
 *
 * Created on Mar 16, 2011, 2:42:59 PM
 */
...
public class dialogPelanggan extends javax.swing.JDialog {
    ...
    public dialogPelanggan(java.awt.Frame parent, boolean modal) {
        ...
        jTable1.setModel(tmps);

        sorter = new TableRowSorter<TableModel>(tmps);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount()==2){
            setN(jTable1.getSelectedRow());
            setVisible(false);
        }
    }//GEN-LAST:event_jTable1MouseClicked


    tmPelangganSearch tmps=new tmPelangganSearch();
