...
public class dialogProduk extends javax.swing.JDialog {
    ...
    private void botton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botton1ActionPerformed
        if(!jTextField1.getText().trim().equals("")){
            dtProduk dtp=new dtProduk();
            dtp.setNamaProduk(jTextField1.getText());

            if(dbProduk.insert(dtp))
                tmProduk.insert(dtp);
            jTextField1.setText("");
        }
        else
            JOptionPane.showMessageDialog(rootPane, "Isi Produk Obat !!!","ERROT",JOptionPane.ERROR_MESSAGE);
    ...
    private void botton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botton2ActionPerformed
        ...
        if(n>=0){
            if(dbProduk.delete(tmProduk.fieldProduk.get(n).getNamaProduk()))
            tmProduk.delete(n);
        }
        else
    ...
    tmProduk tmProduk=new tmProduk();
